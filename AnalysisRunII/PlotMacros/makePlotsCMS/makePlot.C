...
void makeLTauStack(TString name,TString file,TString dir,int s,TString labelX,TString units = "GeV",bool left=false,TString channel = "",TString json = "Golden",bool log = false,bool dndm=false,bool doRatio = false, int blind=900, bool doFit=false)
{
    ...
    if (json=="Golden") lumi_13TeV = channel+"    2016, 35.870 fb^{-1}";
    ...
    */
    ...
    float qcdError = 0.40;
    float zttError = 0.05;
    float zlftError = 0.05;
    float zjftError = 0.05;
    float zvvError = 0.05;
    ...
    TH1F * ttbarJ = (TH1F*)(f->Get(dir+"/TTJ"));
    ttbar->Add(ttbarJ);
    ...
    TH1F * VV = (TH1F*)(f->Get(dir+"/VVT"));
    TH1F * VVJ = (TH1F*)(f->Get(dir+"/VVJ"));
    VV->Add(VVJ);
